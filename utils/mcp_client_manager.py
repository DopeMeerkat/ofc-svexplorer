...
DEFAULT_OVERLAP_URL = "http://127.0.0.1:8103/mcp"
DEFAULT_DISCOVERY_URL = "http://127.0.0.1:8104/mcp"
...
class MCPClientManager:
    def __init__(self) -> None:
        ...
        self.overlap_url = os.getenv("MCP_OVERLAP_SERVER_URL", DEFAULT_OVERLAP_URL)
        self.discovery_url = os.getenv("MCP_DISCOVERY_SERVER_URL", DEFAULT_DISCOVERY_URL)
    ...
    def call_overlap_tool(self, tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
        payload = {"tool": tool_name, "arguments": arguments}
        return _post_json(self.overlap_url, payload, self.timeout)

    def call_discovery_tool(self, tool_name: str, arguments: dict[str, Any]) -> dict[str, Any]:
        payload = {"tool": tool_name, "arguments": arguments}
        return _post_json(self.discovery_url, payload, self.timeout)
